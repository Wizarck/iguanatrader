...
from sqlalchemy import ForeignKey, ForeignKeyConstraint, Index, Table, UniqueConstraint
...
def test_pk_name_pattern() -> None:
    table = cast(Table, _ParentTbl.__table__)
...
def test_fk_name_pattern() -> None:
    table = cast(Table, _ChildTbl.__table__)
